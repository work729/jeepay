...
import com.jeequan.jeepay.core.security.AuthTokenUtil;
...
public class JeeAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    private JeeUserDetails commonFilter(HttpServletRequest request){
        String jwtSecret = SpringBeansUtil.getBean(SystemYmlConfig.class).getJwtSecret();
        return AuthTokenUtil.resolveUserByToken(request, jwtSecret);
    }
